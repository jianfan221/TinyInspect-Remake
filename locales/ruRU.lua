...
ns.L = {
    ...
    AnnouncementChat            = "TinyInspect-Remake продолжит получать обновления для версии 12.1. Если ошибки мешают игре, временно отключите аддон и дождитесь обновления.",
    General                     = "Общие",
